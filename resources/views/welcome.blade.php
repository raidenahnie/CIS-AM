...
<head>
    ...
    <title>CID-AMS | Attendance Monitoring System</title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-md fixed top-0 left-0 w-full z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <h1 class="text-2xl font-bold text-indigo-600">CID-AMS</h1>
            ...
            <div>
                <a href="*" class="px-4 py-2 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700">
                    Login
                </a>
            </div>
        </div>
    ...
    <section class="pt-32 pb-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div class="max-w-5xl mx-auto text-center px-6">
            <h2 class="text-4xl md:text-6xl font-extrabold mb-6">Smart Attendance Monitoring</h2>
            <p class="text-lg md:text-xl mb-8">
                Track attendance seamlessly with GPS-powered validation.<br>
                Secure, accurate, and built for modern organizations.
            </p>
            <a href="*" class="px-6 py-3 bg-white text-indigo-600 font-semibold rounded-lg shadow hover:bg-gray-100">
                Get Started
            </a>
        </div>
    </section>
    ...
    <section id="about" class="py-20">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h3 class="text-3xl font-bold mb-6">About CID-AMS</h3>
            <p class="text-gray-700 text-lg">
                CID-AMS (Curriculum Implementation Division - Attendance Monitoring System) is designed 
                to simplify and secure attendance tracking using cutting-edge GPS technology. 
                Whether you’re an educational institution or a workplace, CID-AMS adapts to your needs.
            </p>
        </div>
    </section>
    ...
    <section id="contact" class="py-20 bg-gray-100">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <a href="mailto:info@cid-ams.test" class="px-6 py-3 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700">
                Email Us
            </a>
        </div>
    </section>
